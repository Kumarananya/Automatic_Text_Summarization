...
text="Ananya! how are you. Parinita! how are you. He always want to live a happy life.Ananya is a good boy"
keyphrases="Ananya is a good. He always want happy life. Parinita you."
...
def get_Labeled_sent(keyphrase,text):
    ...
    for index,each_sent in enumerate(sentences):
        each_sent=string.Punctations(each_sent.lower())
        sent_words=string.word_tokenize(each_sent)
        sent_words=string.StopWords(sent_words)
    ...
    keyphrase=string.Punctations(keyphrase.lower())
    keyphrase_words=string.word_tokenize(keyphrase)
    keyphrase_words=string.StopWords(keyphrase_words)
