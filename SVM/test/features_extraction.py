import os
from Input import *
from preprocessing import removePunctations,removeStopWords,TitleScore,SentencePositionScore,SentenceLengthScore,Summary
...
from insertion import clear_values,insertion


URL="https://newsapi.org/v2/top-headlines?sources=the-hindu&apiKey=f0c5fe6171be4766a6fc5952f0c6f560"
...
def crawl_data():
    ...
    for i in range(len(ja)):
        ...
        insertion(title,image[i],url[i],summary,so,author[i])
